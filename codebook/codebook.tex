...
\setCJKmainfont[
  BoldFont = Noto Sans CJK TC:style=Bold,
  ItalicFont = Noto Sans CJK TC:style=Regular
]{Noto Sans CJK TC:style=Regular}
\setCJKmonofont{Noto Sans CJK TC:style=Regular}
...
\fancyhead[L]{illumeow version codebook}
\fancyhead[R]{\thepage}
